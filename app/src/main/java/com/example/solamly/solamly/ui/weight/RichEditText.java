...
public class RichEditText extends EditText {
    ...
    public void addImage(Bitmap bitmap, String filePath) {
        ...
        String pathTag = "<p><img src=\"" + filePath + "\"/></p>";
...
//                    addDefaultImage(localFilePath, matchStringStartIndex, matchStringEndIndex);
    ...
    private DisplayImageOptions getDisplayImageOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.bg_code_btn)
                .showImageForEmptyUri(R.drawable.bg_code_btn)
                .showImageOnFail(R.drawable.bg_code_btn)
                .cacheOnDisk(true)
                .cacheInMemory(true)
